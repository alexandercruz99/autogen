...
STATIONS: dict[str, StationSpec] = {
    ...
    "LAX": StationSpec(
        city_key="LAX",
        display_name="Los Angeles (Downtown / Civic Center area — verify CLI header)",
        series_prefixes=("KXHIGHLAX", "HIGHLAX", "KXLOWLAX", "LOWLAX"),
        cli_location_id="LAX",
        wfo_office="KLOX",
        climate_station_name="LOS ANGELES DOWNTOWN",
        timezone="America/Los_Angeles",
        lat=34.0522,
        lon=-118.2437,
        metar_ids=("KCQT", "KLAX"),
        notes="Confirm each market rules_primary matches this CLI location before live sizing.",
    ),
    "CHI": StationSpec(
        city_key="CHI",
